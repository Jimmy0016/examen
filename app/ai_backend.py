...
return ('CI/CD significa Integración Continua y Entrega/Despliegue Continuo. '\
'En resumen: 1) los cambios se integran con frecuencia, 2) pruebas automatizadas, '\
'3) imágenes/artefactos se construyen y 4) se despliegan automáticamente.')
if 'docker' in p:
return ('Docker es una plataforma para empaquetar aplicaciones en contenedores ligeros. '\
...
return f"Interesante pregunta: '{prompt}'. Aquí hay una respuesta genérica: intenta proporcionar más contexto."